...
const TopBar: React.FC = () => {
    ...
    let cartPopup = useSelector<AppState,boolean>((state: AppState) => state.cartPopupAppear)
    ...
    let openCartPopupHandler = useCallback(()=>{
        if(activeView !== "cart")
    ...
    return (
      <header>
          ...
          {
              <div className="SquaredButtons" id="cart-button-container" onClick={openCartPopupHandler}>
          ...
          {(cartPopup && activeView !== "cart") && <CartPopUp/>}
      </header>
  );
}
